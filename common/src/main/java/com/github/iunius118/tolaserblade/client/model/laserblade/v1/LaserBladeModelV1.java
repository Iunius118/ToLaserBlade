...
public class LaserBladeModelV1 extends SimpleLaserBladeModel {
    ...
    private static final Identifier TEXTURE = CommonClass.modLocation("textures/item/laser_blade_3d.png");
    ...
    @Override
    public void submit(ItemStack itemStack, ItemDisplayContext mode, PoseStack poseStack,
        ...
        for (ModelObject modelObject : modelObjects) {
            ...
            if (modelObject.isFunction) {
                ...
                int lightColorCoordinate = modelObject.getLightColor(lightCoords);
                renderQuads(poseStack, submitNodeCollector, order, renderType, modelObject.quads, color,
                        lightColorCoordinate, overlayCoords);
                order++;
            }
        }
