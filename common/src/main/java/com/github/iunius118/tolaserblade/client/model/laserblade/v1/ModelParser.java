...
class ModelParser {
    private static final Logger LOGGER = LoggerFactory.getLogger(Constants.MOD_NAME + ".LaserBladeModelVersion1");
    ...
    private static LaserBladeModelV1 createLaserBladeModel(String modelName, JsonModelV1 jsonModel) {
        ...
        for (int oi = 0; oi < jsonModel.objects.size(); oi++) {
            ...
            var modelObject =
                    new ModelObject(modelName + ":objects/" + oi, jsonModelObject, vertices, colors, normals, faces);
