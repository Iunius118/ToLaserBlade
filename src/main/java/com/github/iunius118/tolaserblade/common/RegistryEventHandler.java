...
public class RegistryEventHandler {
    ...
    private static void registerRecipeSerializers(IEventBus modEventBus) {
        var recipeSerializerRegister = DeferredRegister.create(Registries.RECIPE_SERIALIZER, ToLaserBlade.MOD_ID);
    ...
    private static void registerItems(IEventBus modEventBus) {
        var itemRegister = DeferredRegister.createItems(ToLaserBlade.MOD_ID);
    ...
    private static void registerParticleTypes(IEventBus modEventBus) {
        var particleTypeRegister = DeferredRegister.create(Registries.PARTICLE_TYPE, ToLaserBlade.MOD_ID);
