...
public class TLBServerConfig {
    ...
    static {
        ...
        LASER_BLADE_EFFICIENCY = BUILDER
                .comment("""
                        An integer value (0-128) that is a factor of mining speed of Laser Blade.
                        Default: 12""")
        ...
        LASER_BLADE_BASE_DAMAGE = BUILDER
                .comment("""
                        A real number value (0.0-2046.0) that is the base attack damage of Laser Blade.
                        Default: 6.0""")
        ...
        LASER_BLADE_BASE_SPEED = BUILDER
                .comment("""
                        A real number value (0.8-2.8) that is the base attack speed of Laser Blade.
                        Default: 2.8""")
        ...
        ATTACK_DAMAGE_UPGRADE_MULTIPLIER = BUILDER
                .comment("""
                        An integer value (1-2048) that is the damage multiplier for attack damage upgrade of Laser Blade.
                        Default: 1""")
