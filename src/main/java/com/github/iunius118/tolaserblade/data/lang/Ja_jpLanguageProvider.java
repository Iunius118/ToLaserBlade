...
public class Ja_jpLanguageProvider extends En_usLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("tolaserblade.configgui.server.laserBladeBaseDamage", "レーザーブレイドの基礎攻撃力 (0.0–2046.0)");
        add("tolaserblade.configgui.server.laserBladeBaseSpeed", "レーザーブレイドの基礎攻撃速度 (0.8–2.8)");
        add("tolaserblade.configgui.server.maxAttackDamageUpgradeCount", "攻撃力の最大強化回数 (0–2047)");
