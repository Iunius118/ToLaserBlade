...
public class LaserBladeRenderType extends RenderType {
    ...
    protected static RenderType.CompositeState getUnlitRenderState(ResourceLocation texture) {
        return RenderType.CompositeState.builder()
    ...
    protected static RenderType.CompositeState getAddRenderState(ResourceLocation texture) {
        return RenderType.CompositeState.builder()
                .setShaderState(LASER_BLADE_UNLIT_SHADER_STATE)
                .setTextureState(new TextureStateShard(texture, TriState.FALSE, false))
    ...
    protected static RenderType.CompositeState getSubRenderState(ResourceLocation texture) {
    ...
    protected static Optional<RenderType> getRenderType(String name, RenderType.CompositeState compositeState) {
