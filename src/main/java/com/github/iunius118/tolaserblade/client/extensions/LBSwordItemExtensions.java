...
public class LBSwordItemExtensions implements IClientItemExtensions {
	...
	public boolean applyForgeHandTransform(PoseStack poseStack, LocalPlayer player, HumanoidArm arm,
										   ...
										   float swingProcess) {
		// Fix the main-hand pose being applied twice while blocking
		if (itemInHand.getItem() instanceof LBSwordItem) {
			...
			return IClientItemExtensions.super.applyForgeHandTransform(
					poseStack, player, arm, itemInHand, partialTick, equipProcess, swingProcess);
		}
	}
}
