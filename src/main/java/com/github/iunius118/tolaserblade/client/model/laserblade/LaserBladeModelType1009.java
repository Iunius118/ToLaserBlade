...
public class LaserBladeModelType1009 extends SimpleLaserBladeModel {
    ...
    public void render(ItemStack itemStack, ItemTransforms.TransformType mode, PoseStack matrices, MultiBufferSource vertexConsumers, int light, int overlay) {
        ...
        if (color.isBroken) {
            ...
            renderQuads(matrices, currentBuffer, BLADE_OFF_QUADS, offColor, light, overlay);
            return;
        }

        renderQuads(matrices, currentBuffer, HILT_QUADS, color.gripColor, fullLight, overlay);
        renderQuads(matrices, currentBuffer, BLADE_OFF_QUADS, offColor, fullLight, overlay);
        ...
        renderQuads(matrices, currentBuffer, BLADE_MID_QUADS, color.innerColor, fullLight, overlay);
