...
public class LaserBladeItemModelType1 extends SimpleItemModel {
    ...
    public void render(ItemStack itemStack, MatrixStack matrixStack, IRenderTypeBuffer buffer, int lightmapCoord, int overlayColor) {
        ...
        if (color.isBroken) {
            renderFaces(matrixStack, currentBuffer, hilt2Faces, color.gripColor, lightmapCoord, overlayColor);
            return;
        }
    ...
    public static List<FaceData> getHiltFaces() {
        ...
        builder.add(new FaceData(v3, c, v35, v83, v2, c, v34, v83, v1, c, v33, v83, v0, c, v32, v83));
        builder.add(new FaceData(v5, c, v37, v83, v3, c, v35, v83, v0, c, v32, v83, v4, c, v36, v83));
        builder.add(new FaceData(v2, c, v34, v83, v7, c, v39, v83, v6, c, v38, v83, v1, c, v33, v83));
        builder.add(new FaceData(v6, c, v38, v83, v7, c, v39, v83, v5, c, v37, v83, v4, c, v36, v83));
        builder.add(new FaceData(v9, c, v43, v84, v8, c, v42, v84, v1, c, v41, v84, v6, c, v40, v84));
        builder.add(new FaceData(v8, c, v46, v85, v10, c, v45, v85, v0, c, v32, v85, v1, c, v44, v85));
        builder.add(new FaceData(v10, c, v45, v86, v11, c, v47, v86, v4, c, v36, v86, v0, c, v32, v86));
        builder.add(new FaceData(v11, c, v47, v87, v9, c, v43, v87, v6, c, v40, v87, v4, c, v36, v87));
        builder.add(new FaceData(v11, c, v40, v88, v10, c, v36, v88, v8, c, v38, v88, v9, c, v48, v88));
        builder.add(new FaceData(v15, c, v52, v84, v14, c, v51, v84, v13, c, v50, v84, v12, c, v49, v84));
        builder.add(new FaceData(v14, c, v56, v85, v17, c, v55, v85, v16, c, v54, v85, v13, c, v53, v85));
        builder.add(new FaceData(v17, c, v55, v86, v19, c, v58, v86, v18, c, v57, v86, v16, c, v54, v86));
        builder.add(new FaceData(v19, c, v58, v87, v15, c, v52, v87, v12, c, v49, v87, v18, c, v57, v87));
        builder.add(new FaceData(v19, c, v49, v88, v17, c, v57, v88, v14, c, v60, v88, v15, c, v59, v88));
        return builder.build();
    }

    public static final List<FaceData> hilt2Faces = getHilt2Faces();

    public static List<FaceData> getHilt2Faces() {
        Vector4f c = new Vector4f(0.8F, 0.8F, 0.8F, 1F);

        ImmutableList.Builder<FaceData> builder = ImmutableList.builder();
        builder.add(new FaceData(v3, c, v35, v83, v5, c, v37, v83, v7, c, v39, v83, v2, c, v34, v83));
        return builder.build();
    }
    ...
    public static List<FaceData> getBladeOutFaces() {
        ...
        ImmutableList.Builder<FaceData> builder = ImmutableList.builder();
        builder.add(new FaceData(v21, c, v64, v84, v5, c, v63, v84, v3, c, v62, v84, v20, c, v61, v84));
        builder.add(new FaceData(v22, c, v68, v85, v7, c, v67, v85, v5, c, v66, v85, v21, c, v65, v85));
        builder.add(new FaceData(v23, c, v65, v86, v2, c, v66, v86, v7, c, v70, v86, v22, c, v69, v86));
        builder.add(new FaceData(v20, c, v69, v87, v3, c, v70, v87, v2, c, v63, v87, v23, c, v64, v87));
        builder.add(new FaceData(v22, c, v72, v88, v21, c, v64, v88, v20, c, v69, v88, v23, c, v71, v88));
        builder.add(new FaceData(v2, c, v73, v83, v3, c, v65, v83, v5, c, v69, v83, v7, c, v71, v83));
        return builder.build();
    }
    ...
    public static List<FaceData> getBladeInFaces() {
        ...
        ImmutableList.Builder<FaceData> builder = ImmutableList.builder();
        builder.add(new FaceData(v27, c, v76, v84, v26, c, v75, v84, v25, c, v68, v84, v24, c, v74, v84));
        builder.add(new FaceData(v26, c, v80, v85, v29, c, v79, v85, v28, c, v78, v85, v25, c, v77, v85));
        builder.add(new FaceData(v29, c, v79, v86, v31, c, v82, v86, v30, c, v81, v86, v28, c, v78, v86));
        builder.add(new FaceData(v31, c, v82, v87, v27, c, v76, v87, v24, c, v74, v87, v30, c, v81, v87));
        builder.add(new FaceData(v24, c, v58, v83, v25, c, v55, v83, v28, c, v78, v83, v30, c, v81, v83));
        builder.add(new FaceData(v27, c, v52, v88, v31, c, v74, v88, v29, c, v81, v88, v26, c, v58, v88));
        return builder.build();
    }
}
