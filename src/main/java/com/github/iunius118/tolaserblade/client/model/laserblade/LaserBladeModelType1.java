...
public class LaserBladeModelType1 extends SimpleModel {
    ...
    public void render(ItemStack itemStack, MatrixStack matrixStack, IRenderTypeBuffer buffer, int lightmapCoord, int overlayColor) {
        ...
        renderQuads(matrixStack, currentBuffer, BLADE_OUT_QUADS, color.simpleOuterColor, fullLight, overlayColor);
    ...
    static {
        ...
        Vec2f v47 = new Vec2f(0.31250F, 0.12500F);
        Vec2f v77 = new Vec2f(0.00000F, 0.21875F);
        Vec2f v33 = new Vec2f(0.21875F, 0.00000F);
        Vec2f v66 = new Vec2f(0.18750F, 0.75000F);
        Vec2f v82 = new Vec2f(0.06250F, 0.71875F);
        Vec2f v51 = new Vec2f(0.12500F, 0.18750F);
        Vec2f v36 = new Vec2f(0.31250F, 0.09375F);
        Vec2f v32 = new Vec2f(0.21875F, 0.09375F);
        Vec2f v61 = new Vec2f(0.37500F, 0.21875F);
        Vec2f v35 = new Vec2f(0.234375F, 0.078125F);
        Vec2f v48 = new Vec2f(0.40625F, 0.00000F);
        Vec2f v70 = new Vec2f(0.25000F, 0.75000F);
        Vec2f v44 = new Vec2f(0.12500F, 0.09375F);
        Vec2f v65 = new Vec2f(0.18750F, 0.21875F);
        Vec2f v81 = new Vec2f(0.06250F, 0.21875F);
        Vec2f v68 = new Vec2f(0.12500F, 0.21875F);
        Vec2f v75 = new Vec2f(0.12500F, 0.71875F);
        Vec2f v64 = new Vec2f(0.31250F, 0.21875F);
        Vec2f v74 = new Vec2f(0.09375F, 0.21875F);
        Vec2f v55 = new Vec2f(0.03125F, 0.18750F);
        Vec2f v39 = new Vec2f(0.296875F, 0.015625F);
        Vec2f v78 = new Vec2f(0.03125F, 0.21875F);
        Vec2f v43 = new Vec2f(0.40625F, 0.12500F);
        Vec2f v76 = new Vec2f(0.09375F, 0.71875F);
        Vec2f v53 = new Vec2f(0.00000F, 0.03125F);
        Vec2f v80 = new Vec2f(0.00000F, 0.71875F);
        Vec2f v41 = new Vec2f(0.50000F, 0.09375F);
        Vec2f v59 = new Vec2f(0.09375F, 0.00000F);
        Vec2f v54 = new Vec2f(0.03125F, 0.03125F);
        Vec2f v56 = new Vec2f(0.00000F, 0.18750F);
        Vec2f v50 = new Vec2f(0.12500F, 0.03125F);
        Vec2f v46 = new Vec2f(0.12500F, 0.12500F);
        Vec2f v72 = new Vec2f(0.31250F, 0.15625F);
        Vec2f v71 = new Vec2f(0.25000F, 0.15625F);
        Vec2f v69 = new Vec2f(0.25000F, 0.21875F);
        Vec2f v67 = new Vec2f(0.12500F, 0.75000F);
        Vec2f v45 = new Vec2f(0.21875F, 0.12500F);
        Vec2f v42 = new Vec2f(0.50000F, 0.12500F);
        Vec2f v79 = new Vec2f(0.03125F, 0.71875F);
        Vec2f v57 = new Vec2f(0.06250F, 0.03125F);
        Vec2f v58 = new Vec2f(0.06250F, 0.18750F);
        Vec2f v62 = new Vec2f(0.37500F, 0.75000F);
        Vec2f v40 = new Vec2f(0.40625F, 0.09375F);
        Vec2f v38 = new Vec2f(0.31250F, 0.00000F);
        Vec2f v34 = new Vec2f(0.234375F, 0.015625F);
        Vec2f v60 = new Vec2f(0.06250F, 0.00000F);
        Vec2f v73 = new Vec2f(0.18750F, 0.15625F);
        Vec2f v63 = new Vec2f(0.31250F, 0.75000F);
        Vec2f v49 = new Vec2f(0.09375F, 0.03125F);
        Vec2f v52 = new Vec2f(0.09375F, 0.18750F);
        Vec2f v37 = new Vec2f(0.296875F, 0.078125F);
