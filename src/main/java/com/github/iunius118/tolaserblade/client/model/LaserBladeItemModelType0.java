...
public class LaserBladeItemModelType0 extends SimpleItemModel {
    ...
    private static final Vector3f v23 = new Vector3f(-0.031200F, 0.375000F, -0.031300F);
    ...
    private static final Vector3f v33 = new Vector3f(0.093750F, 1.500000F, 0.093750F);
    ...
    private static final Vector3f v18 = new Vector3f(0.031300F, 0.375000F, 0.031200F);
    private static final Vector3f v15 = new Vector3f(-0.031250F, 0.000000F, 0.031250F);
    private static final Vector3f v102 = new Vector3f(0.00000F, 0.00005F, 1.00000F);
    private static final Vector3f v25 = new Vector3f(0.062550F, 1.437550F, 0.062450F);
    private static final Vector3f v9 = new Vector3f(0.031250F, 0.312500F, -0.031250F);
    private static final Vector3f v16 = new Vector3f(-0.031200F, 1.375000F, 0.031200F);
    private static final Vector3f v30 = new Vector3f(-0.062450F, 1.437550F, -0.062550F);
    ...
    private static final Vector3f v105 = new Vector3f(-1.00000F, 0.00005F, 0.00000F);
    private static final Vector3f v21 = new Vector3f(0.031300F, 0.375000F, -0.031300F);
    private static final Vector3f v104 = new Vector3f(0.00000F, -0.00005F, -1.00000F);
    ...
    private static final Vector3f v103 = new Vector3f(1.00000F, -0.00005F, 0.00000F);
    private static final Vector3f v101 = new Vector3f(0.00000F, 1.00000F, 0.00000F);
    private static final Vector3f v35 = new Vector3f(-0.093750F, 1.500000F, -0.093750F);
    ...
    private static final Vector3f v17 = new Vector3f(0.031300F, 1.375000F, 0.031200F);
    private static final Vector3f v99 = new Vector3f(-1.00000F, 0.00000F, 0.00000F);
    private static final Vector3f v19 = new Vector3f(-0.031200F, 0.375000F, 0.031200F);
    private static final Vector3f v28 = new Vector3f(0.062550F, 1.437550F, -0.062550F);
    private static final Vector3f v32 = new Vector3f(-0.093750F, 1.500000F, 0.093750F);
    private static final Vector3f v20 = new Vector3f(0.031300F, 1.375000F, -0.031300F);
    private static final Vector3f v24 = new Vector3f(-0.062450F, 1.437550F, 0.062450F);
    ...
    private static final Vector3f v22 = new Vector3f(-0.031200F, 1.375000F, -0.031300F);
    private static final Vector3f v34 = new Vector3f(0.093750F, 1.500000F, -0.093750F);
    ...
    public static List<FaceData> getBladeMidFaces() {
        ...
        ImmutableList.Builder<FaceData> builder = ImmutableList.builder();
        builder.add(new FaceData(v27, c, v75, v102, v26, c, v74, v102, v25, c, v73, v102, v24, c, v72, v102));
        builder.add(new FaceData(v26, c, v78, v103, v29, c, v77, v103, v28, c, v76, v103, v25, c, v63, v103));
        builder.add(new FaceData(v29, c, v77, v104, v31, c, v80, v104, v30, c, v79, v104, v28, c, v76, v104));
        builder.add(new FaceData(v31, c, v80, v105, v27, c, v75, v105, v24, c, v72, v105, v30, c, v79, v105));
