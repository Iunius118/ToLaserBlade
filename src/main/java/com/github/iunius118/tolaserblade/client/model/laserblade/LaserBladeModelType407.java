...
public class LaserBladeModelType407 extends SimpleModel {
    ...
    static {
        ...
        Vec2f v48 = new Vec2f(0.18750F, 0.81250F);
        Vec2f v29 = new Vec2f(0.06250F, 0.00000F);
        Vec2f v46 = new Vec2f(0.31250F, 0.81250F);
        Vec2f v53 = new Vec2f(0.25000F, 0.18750F);
        Vec2f v34 = new Vec2f(0.12500F, 0.25000F);
        Vec2f v41 = new Vec2f(0.06250F, 0.25000F);
        Vec2f v30 = new Vec2f(0.12500F, 0.03125F);
        Vec2f v39 = new Vec2f(0.03125F, 0.78125F);
        Vec2f v38 = new Vec2f(0.03125F, 0.25000F);
        Vec2f v52 = new Vec2f(0.18750F, 0.18750F);
        Vec2f v54 = new Vec2f(0.31250F, 0.18750F);
        Vec2f v42 = new Vec2f(0.06250F, 0.78125F);
        Vec2f v44 = new Vec2f(0.37500F, 0.25000F);
        Vec2f v24 = new Vec2f(0.06250F, 0.03125F);
        Vec2f v32 = new Vec2f(0.03125F, 0.00000F);
        Vec2f v20 = new Vec2f(0.00000F, 0.03125F);
        Vec2f v50 = new Vec2f(0.25000F, 0.25000F);
        Vec2f v43 = new Vec2f(0.31250F, 0.25000F);
        Vec2f v26 = new Vec2f(0.09375F, 0.03125F);
        Vec2f v36 = new Vec2f(0.09375F, 0.78125F);
        Vec2f v35 = new Vec2f(0.12500F, 0.78125F);
        Vec2f v49 = new Vec2f(0.12500F, 0.81250F);
        Vec2f v31 = new Vec2f(0.12500F, 0.21875F);
        Vec2f v37 = new Vec2f(0.00000F, 0.25000F);
        Vec2f v21 = new Vec2f(0.03125F, 0.03125F);
        Vec2f v25 = new Vec2f(0.06250F, 0.21875F);
        Vec2f v51 = new Vec2f(0.25000F, 0.81250F);
        Vec2f v47 = new Vec2f(0.18750F, 0.25000F);
        Vec2f v33 = new Vec2f(0.09375F, 0.25000F);
        Vec2f v40 = new Vec2f(0.00000F, 0.78125F);
        Vec2f v45 = new Vec2f(0.37500F, 0.81250F);
        Vec2f v23 = new Vec2f(0.00000F, 0.21875F);
        Vec2f v27 = new Vec2f(0.09375F, 0.21875F);
        Vec2f v22 = new Vec2f(0.03125F, 0.21875F);
