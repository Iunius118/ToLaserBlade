    ...
    public static class Client {
        ...
        Client(ForgeConfigSpec.Builder builder) {
            ...
            internalModelType = builder
                    .comment("Select type of internal model to use for rendering Laser Blade (0: original model, 1: another model, 2: default model). This is valid when useInternalModel is true.\n" +
                            "Need to reload resource packs after changing this.\n" +
                            "Default: -1")
